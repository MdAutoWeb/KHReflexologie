              ...
              <div className="space-y-8">
                <div className="space-y-5">
                  ...
                  <p className="text-[#3F342C]/80 text-base md:text-lg leading-relaxed font-light">
                    Voetreflexologie is een zachte, ontspannende behandeling
                    waarbij via druk op reflexzones in de voeten de
                    zelfherstellende kracht van het lichaam wordt gestimuleerd.
                    Het hele lichaam wordt als het ware weerspiegeld in de
                    voeten.
                  </p>
                  <p className="text-[#3F342C]/80 text-base md:text-lg leading-relaxed font-light">
                    Door deze zones met aandacht en zorg te behandelen, wordt
                    het lichaam uitgenodigd om terug in evenwicht te komen en
                    spanning los te laten – zowel fysiek als emotioneel.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <ul className="space-y-3 text-[#3F342C]/85 text-sm md:text-base font-light">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        Werkt diep ontspannend, zowel op fysiek als op mentaal
                        vlak
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1 h-1.5 w-1.5 rounded-full bg-[#B8A89A]" />
                      <span>
                        Activeert het zelfregulerend systeem en het lymfestelsel
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1 h-1.5 w-1.5 rounded-full bg-[#B8A89A]" />
