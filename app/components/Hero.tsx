            ...
            <div className="container mx-auto px-6">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 max-w-6xl mx-auto relative">
                ...
                <div className="text-white mt-8 lg:mt-0 relative">
                  ...
                  <p className={`text-sm md:text-base text-white leading-relaxed font-light ${showIntroCta ? 'mb-6' : ''}`}>
              ...
              <div className="max-w-4xl mx-auto bg-black/50 backdrop-blur-sm rounded-lg p-6 md:p-8">
                <div className="flex flex-col md:flex-row gap-6 items-start">
                  ...
                  <div className="flex-1 text-white">
                    <div className="text-4xl md:text-5xl text-white/80 mb-2 leading-none font-serif">&ldquo;</div>
                    ...
                    <div>
                      ...
                      <p className="text-white/70 text-xs mt-1 font-light">Down To Earth Massage</p>
                    </div>
                  </div>
                </div>
              </div>
