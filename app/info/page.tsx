            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
              <div>
                ...
                <p className="text-[#3F342C]/80 text-base md:text-lg leading-relaxed font-light mb-8">
                  Om het maximale uit je sessie te halen en de ontspanning direct te
                  laten beginnen, heb ik een paar kleine tips:
                </p>
                <div className="space-y-5">
                  {preparationTips.map((tip) => (
                    <p
                      key={tip.title}
                      className="text-[#3F342C]/80 text-base leading-relaxed font-light"
                    >
                      <span className="font-serif text-[#3F342C]">
                        {tip.title}:
                      </span>{" "}
                      {tip.text}
                    </p>
              ...
              <div className="relative w-full h-[420px] lg:h-[500px] rounded-xl overflow-hidden shadow-lg">
                <Image
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto space-y-10">
            ...
            <div>
              ...
              <p className="text-[#3F342C]/80 text-base leading-relaxed font-light">
                Reserveren kan direct via de link op deze website of per e-mail
                indien de beschikbare tijden niet passen.
              </p>
            </div>
          </div>
        </div>
